...
public final class DefaultDockerFinder implements BuildXFinder, DockerFinder
{
	...
	@Override
	public DockerClient fromPath() throws IOException
	{
		return new DefaultDockerClient(getExecutableFromPath());
	}
}